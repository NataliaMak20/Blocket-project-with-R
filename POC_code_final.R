...
# Loading data
data <- read_excel("C:/Users/Admin/Desktop/R/BlocketBilData.xlsx", sheet = "raw_data")
...
#one_hot_train_strat <- one_hot(as.data.frame(X_train_strat[, c("Bränsle", "Växellåda", "Modellår", "Biltyp", "Miltal_mitten")]))
#one_hot_test_strat <- one_hot(as.data.frame(X_test_strat[, c("Bränsle", "Växellåda", "Modellår", "Biltyp", "Miltal_mitten")]))
